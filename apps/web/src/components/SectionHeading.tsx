/**
 * The reference's signature heading: heavy upright caps, with the final word
 * set in red italic, over a letterspaced subtitle and a short red rule.
 */
export function SectionHeading({
  ...
  return (
    <header className="text-center">
      <h2 className="display-upright text-3xl sm:text-4xl md:text-5xl">
        {lead} <span className="display ml-[0.12em] text-accent">{accent}</span>
      </h2>
